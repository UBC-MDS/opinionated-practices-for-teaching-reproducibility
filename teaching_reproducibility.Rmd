---
title: "Best practices for teaching reproducibility: motivation, guided instruction and practice"
author:
- Joel Ostblom
- Tiffany A. Timbers
date: "`r Sys.Date()`"
...
which we will outline in the next paragraph [ADD REFS TO CLINICAL TRIALS HERE TOO].
...
would identify which treatments were more effective for individuals.
The series of scientific papers that formed the basis of these trials
were all published in highly regarded "high-impact" journals [CITE THE PAPERS HERE],
but they had also raised some concerns among researchers in the field [CITE THIS OR REMOVE THIS CLAIM].
...
These include
how limitations in Excel data formats lead to the loss of 16,000 COVID case records in the UK [NEED TO CITE SOMETHING HERE],
how Excel's automatic formatting caused important gene names to be disregarded in scientific studies [@zeeberg2004mistaken]
(which has been estimated to affect around 20% of all scientific publications in these areas [@ziemann2016gene]),
how deletion of a cell caused rows to shift and treatment groups to be mixed up [@wallensteen2018retraction]
