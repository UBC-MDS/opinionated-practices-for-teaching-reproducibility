...
is the pedagogy of using case studies of failures
that have had real world consequences
in order to illustrate the importance and impact of this reproducibility.
...
is not always tangible in the moment
compared to e.g. tweaking your model configuration
which could directly impact you model performance;
a very tangible and directly understandable improvement.
