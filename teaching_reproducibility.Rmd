...
abstract: |
    ...
    such as predictive modelling which is often the most interesting topic to novices. 
    ...
    and practice are key to effectively teaching this challenging, yet important subject. 
...
The tools we chose to teach are data science reproducibility software
...
but also increases their proficiency authentic reproducibility software
...
```{r git-is-hard-xkcd, out.width="30%", fig.cap = "Infamous xkcd comic that highlights the difficulty of learning and using the version control software Git.", fig.retina=2, fig.align="center"}
