...
since the benefits of adhering to reproducible practices
are not usually obvious to novices.
This contrasts with the benefits of data science topics 
related to gaining insight from data, 
for example tuning a model to improve predictive performance, 
which are more easily seen and understood by novices.
