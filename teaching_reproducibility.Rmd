...
(ADD LINK HERE) and in class, ask them to go to that GitHub repository,
...
(ADD LINK HERE) that uses Docker as the compute environment reproducibility tool.
...
These points are well stated in a blog post and essay on *The Role of Theory in Data Analysis* by Roger Peng:
...
We provide them a textbook reading for them to review before class,
then we do a live demonstration in class, 
where they watch us use the GitHub website, 
and the Jupyter Git graphical user interface to add, commit,
push and pull changes.
Then finally they work through a guided worksheet that asks them to do 
...
An example of how we use lots of practice in the classroom
