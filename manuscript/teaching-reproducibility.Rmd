...
and the skill bar is put at a level
that we require all student to meet
after introduced to version control topic
during the first few weeks of class.
To engage students at different levels of skill
and interest in reproducibility,
we have more difficult exercises
in the courses specifically teaching these topics
(including demanding optional exercises for bonus points).
Students less experienced and interested in these topics
have shared with us that they find the worksheets
really helpful in preparing them
to successfully complete the lab questions.
...
our once-per term academic retreats where we reflect on how things went,
and our frequent communication and collaboration at our weekly academic meetings.
...
To incentivize doing students to submit their assignment by using Git 
