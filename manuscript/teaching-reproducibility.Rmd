...
reproducibility errors are not isolated to novices performing irrelevant data analyses.
They are occurring at the highest level in both industry and academia
...
and those that come from prolific researchers/companies.
This is to illustrate that these errors can happen to anyone
and emphasize that we are not sharing them cast blame,
but to highlight the importance of reproducible practices on all levels.
Another example that illustrates the previous points
is the misreporting of the relationship between public depth and GDP growth,
which was published in what was regarded as a seminal paper at the time.
