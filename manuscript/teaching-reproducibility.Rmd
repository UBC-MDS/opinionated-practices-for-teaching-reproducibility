...
which consists of 24 one-credit courses over an eight month period
...
in programming, calculus, linear algebra, and introductory statistics or probability.
...
We have a few core members of the program's teaching team
that have been with the program since its inception in 2016,
...
over six years' lifespan
of the Master's of Data science program.
We have embraced student feedback on our teaching practices
from mid-course meetings and surveys from student-elected student representatives,
course evaluations,
and alumni surveys.
...
This was done to address common feedback that we received across the program's curriculum
that what was expected on the lab homework assessments were perceived by students
as too large of a jump in difficulty from what was learned in the lecture.
The change of implementing these lecture worksheets in several of our courses
decreased the feedback we have received about this jump in difficulty in those courses
and thus, we have been incorporating these worksheets
across more and more courses in the program to continue to address this.

One of the key reproducibility-related takeaways from our feedback collection
is that practice matters and that more is better.
In our early Capstone projects,
we observed that students could do the things
where we gave the lots of practice on
(e.g., basic version control skills
and working linearly on the main branch),
but did not attempt or struggled with other reproducibility concepts/tasks
where they were provided formal instructions
but less practice
(e.g., more advanced version control topics like branching, pull-requests, and
intermediate/advanced features of reproducible reports and presentations).
The importance of practice was also apparent in our project-based courses.
In the early years of the program,
we didn't have any practice in project-based course-work,
and the capstone projects from that time had a higher level of technical debt
and did not adhere to the same standards of reproducible practices
as Capstone projects from more recent years.
To address this,
we implemented project-based courses for several reproducibility related topics
and observed that the technical debt during Capstone was lower,
and that the projects were more reproducible.
Encouragingly,
...
and applying it to our own analyses, we have made mistakes,
...
1. Prompt students to think about a non-reproducible or non-auditable workflow
...
3. With the person beside them,
   share their story and how it negatively impacted their workflow.
4. Students were then asked to share their story
...
This helps make the practice of reproducibility seem more applicable
...
use a lot of borrowed knowledge, workflows and tools from software engineering
