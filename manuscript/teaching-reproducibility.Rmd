...
when we decide that the changes are worthwhile
to incorporate into our courses,
such as when R introduced the native pipe operator `|>`
as a preferred alternative to the package-specific `magrittr` pipe operator `%>%`.
