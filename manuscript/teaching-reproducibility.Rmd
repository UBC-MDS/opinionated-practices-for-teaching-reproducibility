...
that the what was expected on the lab homework assessments were perceived by students 
...
which was reflected in the feedback we collect from them.
...
2. The instructor shares a their own example to get the students started.
...
4. Students were then asked to share their story
   in a course forum or collaborative notetaking document
...
we have ran it as an in-class activity that is not counted toward the course grades.
...
indicate that these strategies help to engage students
