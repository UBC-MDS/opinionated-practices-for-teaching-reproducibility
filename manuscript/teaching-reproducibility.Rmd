...
have been tested in classrooms of 10-200 learners from varying educational backgrounds,
including undergraduate students taking their only data science course
...
where students are generally required to have taken one course each
...
but our cohorts includes both fresh undergrads
as well as learners from senior company positions
looking to bend their career trajectories towards data science.
Learners rarely have experience working with reproducible workflows.

The teaching team for our reproducibility courses
include a mix of post-doctoral teaching fellows, lecturers, and assistant professors
from the departments of Statistics and Computer Science.
We have a few core members that have been with the program since its inception,
and several members that stay with the program for 1-3 years.
Members of the teaching team developed their data science expertise
through graduate studies in diverse set of topics,
including machine learning, statistics, computational linguistics, learning analytics, neuroscience, stem cell engineering, ecotoxicology, and physics.
Our pedagogies are influenced not only by our formal training at UBC,
but also by initiatives such as
The Carpentries [@__aq], RStudio education [@__ap], and Teaching Tech Together [@wilson_wilson_2018].
