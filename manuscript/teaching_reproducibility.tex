...
We think over the past five years from teaching in the UBC Master of
Data Science and the UBC introductory data science course, DSCI 100,
that the key things for teaching reproducibility in the data science
classroom are: \emph{1)} providing extra emphasis on motivation so that
students understand why reproducibility is important and buy into
learning about it and practicing it, \emph{2)} providing guided
instruction so that it is not a mystery of how you get started and what
you need to do, as well as \emph{3)} lots and lots of practice so that
we can not only teach them the ideas and the concepts behind
reproducibility, but so that students actually change their data
analysis habits and workflows into reproducible ones that they will use
...
\textbf{Table. 1}: Case studies that illustrate the significant real
world consequences of reproducibility failures in data analyses.
...
\leavevmode\vadjust pre{\hypertarget{ref-wise_aboumatar_2019}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-evers_adriaanse_2011}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-xie2021dynamic}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-baggerly2009deriving}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-blank2019nbgrader}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-rebar_gardner_2019}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-knuth1984literate}{}}%
Knuth, Donald Ervin. 1984. {``Literate Programming.''} \emph{The
Computer Journal} 27 (2): 97--111.

\leavevmode\vadjust pre{\hypertarget{ref-wardle_lally_2010}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-merkel2014docker}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-nederbragt2020ten}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-raj2018role}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-ram2013git}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kusheyrenv}{}}%
Ushey, Kevin. 2021. \emph{Renv: Project Environments}.
\url{https://CRAN.R-project.org/package=renv}.

\leavevmode\vadjust pre{\hypertarget{ref-wallensteen2018retraction}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-turchin_whitehouse_2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-wilson_wilson_2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-zeeberg2004mistaken}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-ziemann2016gene}{}}%
...
\bibliography{teaching\_reproducibility.bib}
